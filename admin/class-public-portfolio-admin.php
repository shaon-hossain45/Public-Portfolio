...
class Public_Portfolio_Admin {
	...
	public function __construct( $plugin_name, $version ) {
		...
		if ( class_exists( 'Public_Portfolio_Admin_Display' ) ) {
			new Public_Portfolio_Admin_Display();
		}
	...
	private function admin_load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/partials/public-portfolio-admin-display.php';
	}
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/public-portfolio-admin.css', array(), $this->version, 'all' );
