 ...
 * @subpackage Public_Portfolio/admin/partials
 */

//use Inc\CptBaseSetup;

class Public_Portfolio_Admin_Display {
	/**
	...
	private function admin_display_load_dependencies() {
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'partials/cmb/custom-meta.php';
	}
